       ...
       `Y$$b.            ##.   ,##  ##        ##    ,##  ##  ##    ##  ##     ##
         `"Y$b._         :#:._,###  ##:__,##  ##:__,##' ,##. ##.__:##. ##     ##
             `""""       `:#### ###  ######'  `######'  #### `#####"## ##     ##
                                ...
                                Your currently login on:
                                  server1.example.com
}

# * Print Output
puts "\033\[01;32m$head\033\[0m"
puts "  \033\[01;35mLast Login....: \033\[0m\033\[01;36m$ll(1) $ll(2) $ll(3) $ll(4) from $ll(5)"
puts "  \033\[01;35mUptime........: \033\[0m\033\[01;36m$up(days)days $up(hours)hours $up(mins)minutes $up(secs)seconds"
puts "  \033\[01;35mLoad..........: \033\[0m\033\[01;36m$sysload(1) (1minute) $sysload(5) (5minutes) $sysload(15) (15minutes)"
puts "  \033\[01;35mMemory MB.....: \033\[0m\033\[01;36m$mem(t)  Used: $mem(u)  Free: $mem(f)  Free Cached: $mem(c)  Swap In Use: $mem(s)"
puts "  \033\[01;35mDisk Usage....: \033\[0m\033\[01;36mYou're using ${usage}MB in $var(home)"
puts "  \033\[01;35mSSH Logins....: \033\[0m\033\[01;36mThere are currently $log(c) users logged in."
puts "  \033\[01;35mProcesses.....: \033\[0m\033\[01;36m$psa total running of which $psu $verb yours"
